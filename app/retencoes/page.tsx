...
export default function RetencoesPage() {
  ...
  const [resultado, setResultado] = useState<{ resultado: import("@/lib/retencoes-fonte/apurar").ResultadoApuracaoFederal } | null>(null);
  ...
  const apurar = async () => {
    ...
    if (!item || !valorServico) {
      setErro("Preencha o item de serviço e o valor.");
      return;
    }
    setLoading(true);
    try {
    ...
    <div className="p-8 max-w-[1920px] mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Apuração de IRRF e PIS/COFINS/CSLL (PCC) ao pagar prestadores de serviço, com base na Tabela Federal
          (IR-PCC) por item da lista de serviços da LC 116/2003.
        </p>
      </div>
